    ...
    public GetFloorsResp getFloors(@RequestParam String userToken,
        ...
        switch (columnId) {
            ...
            case "4006":
                ...
                floors.add(new Floor("0", "轮播类型..", "排序", TemplateType.CAROUSEL, null, null, null, null, appContents1, null));

                List<Content> appContents2 = new ArrayList<>();
                appContents2.add(new Content("1", "相机360", ContentUrl.Pic.PIC_APP_BIG_1, ContentType.APP, null, null, null));
                ...
                appContents2.add(new Content("4", "QQ空间", ContentUrl.Pic.PIC_APP_BIG_4, ContentType.APP, null, null, null));
                appContents2.add(new Content("5", "搜狗输入法", ContentUrl.Pic.PIC_APP_BIG_5, ContentType.APP, null, null, null));
                appContents2.add(new Content("6", "微信", ContentUrl.Pic.PIC_APP_BIG_6, ContentType.APP, null, null, null));
                floors.add(new Floor("0", "热门排行", "排序", TemplateType.TWO_THREE, null, null, null, null, appContents2, null));
                break;
            default:
                resp.result = 1;
