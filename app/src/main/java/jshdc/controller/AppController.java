...
public class AppController {
    ...
    private List<AppInfo> provideAppInfos() {
        ...
        appInfo1.version = "1.0.3";
        appInfo1.name = "相机360";
        appInfo1.description = "\uF0FC\t全球超过5亿用户都在用，受到网友热烈好评\n" +
        ...
        appInfo1.price = null;
        appInfo1.visibleFlag = true;
        appInfo1.appLevel = "1";
        appInfo1.icon = ContentUrl.Pic.PIC_APP_1;
        appInfo1.poster = ContentUrl.Pic.PIC_APP_BIG_1;
        appInfo1.packageSize = (long) (10.7 * 1024);
        appInfo1.developer = "腾讯公司";
        appInfos.add(appInfo1);

        AppInfo appInfo2 = new AppInfo();
        appInfo2.appId = "2";
        appInfo2.appTypeId = null;
        appInfo2.version = "3.0.1.4";
        appInfo2.name = "微博";
        appInfo2.description = "随时随地发现新鲜事！微博带你欣赏世界上每一个精彩瞬间，了解每一个幕后故事。分享你想表达的，让全世界都能听到你的心声。\n" +
                "在微博：\n" +
                "-你能看到最新，最全面的资讯内容。";
        ...
        appInfo2.appLevel = "1";
        appInfo2.icon = ContentUrl.Pic.PIC_APP_2;
        appInfo2.poster = ContentUrl.Pic.PIC_APP_BIG_2;
        appInfo2.packageSize = (long) (18.1 * 1024);
        appInfo2.developer = "新浪公司";
        appInfos.add(appInfo2);

        AppInfo appInfo3 = new AppInfo();
        appInfo3.appId = "3";
        appInfo3.appTypeId = null;
        appInfo3.version = "4.5.6";
        appInfo3.name = "淘宝";
        appInfo3.description = "517淘宝外卖饿货节，全场美食5折起，更有517元大粮票等你来抢！\n" +
                "【软件简介】 \n" +
        ...
        appInfo3.appLevel = "2";
        appInfo3.icon = ContentUrl.Pic.PIC_APP_3;
        appInfo3.poster = ContentUrl.Pic.PIC_APP_BIG_3;
        appInfo3.packageSize = (long) (20.3 * 1024);
        appInfo3.developer = "阿里巴巴集团";
        appInfos.add(appInfo3);

        AppInfo appInfo4 = new AppInfo();
        appInfo4.appId = "4";
        appInfo4.appTypeId = null;
        appInfo4.version = "3.0.1";
        appInfo4.name = "QQ空间";
        appInfo4.description = "QQ空间，致力于帮助用户随时随地“分享生活，留住感动”。您可以使用手机查看好友动态、与好友互动，上传照片、写说说、写日志、签到、送礼；更有“玩吧”汇聚众多热门游戏，满足各种娱乐需求。QQ空间，分享生活，留住感动。";
        ...
        appInfo4.price = null;
        appInfo4.visibleFlag = true;
        appInfo4.appLevel = "1";
        appInfo4.icon = ContentUrl.Pic.PIC_APP_4;
        appInfo4.poster = ContentUrl.Pic.PIC_APP_BIG_4;
        appInfo4.packageSize = (long) (15.7 * 1024);
        appInfo4.developer = "腾讯公司";
        appInfos.add(appInfo4);

        AppInfo appInfo5 = new AppInfo();
        appInfo5.appId = "5";
        appInfo5.appTypeId = null;
        appInfo5.version = "3.9.11";
        appInfo5.name = "搜狗输入法";
        appInfo5.description = "搜狗输入法以提升用户体验为宗旨，致力于为亿万手机用户提供手机端智能、易用的输入法产品。\n" +
        ...
        appInfo5.price = null;
        appInfo5.visibleFlag = true;
        appInfo5.appLevel = "1";
        appInfo5.icon = ContentUrl.Pic.PIC_APP_5;
        appInfo5.poster = ContentUrl.Pic.PIC_APP_BIG_5;
        appInfo5.packageSize = (long) (12.7 * 1024);
        appInfo5.developer = "搜狗公司";
        appInfos.add(appInfo5);

        AppInfo appInfo6 = new AppInfo();
        appInfo6.appId = "6";
        appInfo6.appTypeId = null;
        appInfo6.version = "6.6";
        appInfo6.name = "微信";
        appInfo6.description = "1.可以发语音、文字消息、表情、图片、视频。30M流量可以收发上千条语音。\n" +
                "2.朋友圈，跟朋友们分享生活点滴。\n" +
        ...
        appInfo6.score = "4.8";
        appInfo6.chargeFlag = true;
        appInfo6.price = null;
        appInfo6.visibleFlag = true;
        appInfo6.appLevel = "1";
        appInfo6.icon = ContentUrl.Pic.PIC_APP_6;
        appInfo6.poster = ContentUrl.Pic.PIC_APP_BIG_6;
        appInfo6.packageSize = (long) (30.7 * 1024);
        appInfo6.developer = "腾讯公司";
