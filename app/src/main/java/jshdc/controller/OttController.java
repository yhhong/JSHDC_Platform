...
public class OttController {
    ...
    public GetVodRecommendsResp getVodRecommends(@RequestParam String userToken,
        ...
        vodRecommends.add(new VodRecommend("2", null, "31", "名侦探柯南", ContentUrl.Pic.PIC_SMALL_1, "directors", "actors", "description", "9.1", DateUtil.stringToDate("20010501000000").getTime(), "9999"));
