...
public class OttController {
    ...
    public GetFloorsResp getFloors(@RequestParam String userToken,
        ...
        switch (columnId) {
            case "0":
                ...
                contents1.add(new Content("1", "飞屋环游记", ContentUrl.Pic.PIC_BIG_1, ContentType.VIDEO, "1", ContentUrl.MOVE1, null, null));
                contents1.add(new Content("2", "叛逆的鲁路修第110话", ContentUrl.Pic.PIC_BIG_2, ContentType.VIDEO, "2", ContentUrl.MOVE2, null, null));
                contents1.add(new Content("3", "少年派的奇幻漂流", ContentUrl.Pic.PIC_BIG_3, ContentType.VIDEO, "3", ContentUrl.MOVE3, null, null));
                contents1.add(new Content("4", "海贼王第710话", ContentUrl.Pic.PIC_BIG_4, ContentType.VIDEO, "4", ContentUrl.MOVE4, null, null));
                ...
                contents3.add(new Content("7", "名侦探柯南", ContentUrl.Pic.PIC_SMALL_1, ContentType.VIDEO, "5", ContentUrl.MOVE5, "9.6", null));
                contents3.add(new Content("8", "全职猎人", ContentUrl.Pic.PIC_SMALL_2, ContentType.VIDEO, "6", ContentUrl.MOVE6, "9.6", null));
            ...
            case "1":
                ...
                liveContents1.add(new Content("1", "飞屋环游记", ContentUrl.Pic.PIC_BIG_1, ContentType.PROGRAM, "1", ContentUrl.CCTV1_LOOK_BACK_PROGRAM1, null, null));
                liveContents1.add(new Content("2", "叛逆的鲁路修第110话", ContentUrl.Pic.PIC_BIG_2, ContentType.PROGRAM, "2", ContentUrl.CCTV1_LOOK_BACK_PROGRAM2, null, null));
                liveContents1.add(new Content("3", "少年派的奇幻漂流", ContentUrl.Pic.PIC_BIG_3, ContentType.PROGRAM, "3", ContentUrl.CCTV1_LOOK_BACK_PROGRAM1, null, null));
                liveContents1.add(new Content("4", "海贼王第710话", ContentUrl.Pic.PIC_BIG_4, ContentType.PROGRAM, "4", ContentUrl.CCTV1_LOOK_BACK_PROGRAM1, null, null));
                ...
                liveContents2.add(new Content("9", "巴西世界杯", ContentUrl.Pic.PIC_PROGRAM_1, ContentType.PROGRAM, "5", ContentUrl.CCTV1_LOOK_BACK_PROGRAM1, "9.6", null));
                liveContents2.add(new Content("10", "新闻30分", ContentUrl.Pic.PIC_PROGRAM_2, ContentType.PROGRAM, "6", ContentUrl.CCTV1_LOOK_BACK_PROGRAM2, "9.6", null));
                ...
                liveContents3.add(new Content("11", "湖南卫视", ContentUrl.Pic.PIC_TV_1, ContentType.CHANNEL, "1", ContentUrl.CCTV1, "9.6", "10000次"));
                liveContents3.add(new Content("12", "昆明卫视", ContentUrl.Pic.PIC_TV_2, ContentType.CHANNEL, "2", ContentUrl.CCTV2, "9.6", "2000次"));
                liveContents3.add(new Content("13", "江苏卫视", ContentUrl.Pic.PIC_TV_3, ContentType.CHANNEL, "3", ContentUrl.CCTV3, "9.6", "3000次"));
                liveContents3.add(new Content("14", "东方卫视", ContentUrl.Pic.PIC_TV_4, ContentType.CHANNEL, "4", ContentUrl.CCTV4, "9.6", "5000次"));
                ...
                liveContents4.add(new Content("15", "奔跑吧兄弟", ContentUrl.Pic.PIC_PROGRAM_4, ContentType.CHANNEL, "5", ContentUrl.CCTV5, "9.6", null));
                liveContents4.add(new Content("16", "快乐大本营", ContentUrl.Pic.PIC_PROGRAM_5, ContentType.CHANNEL, "6", ContentUrl.CCTV6, "9.6", null));
                floors.add(new Floor("0", "综艺直播", "排序", TemplateType.COUNT_TWO, ViewType.LIVE_PROGRAMME, null, "更多", null, liveContents4, null));
                break;
            default:
                List<Content> vodContents1 = new ArrayList<>();
                vodContents1.add(new Content("1", "飞屋环游记", ContentUrl.Pic.PIC_BIG_1, ContentType.VIDEO, "1", ContentUrl.MOVE1, null, null));
                vodContents1.add(new Content("2", "叛逆的鲁路修第110话", ContentUrl.Pic.PIC_BIG_2, ContentType.VIDEO, "2", ContentUrl.MOVE2, null, null));
                vodContents1.add(new Content("3", "少年派的奇幻漂流", ContentUrl.Pic.PIC_BIG_3, ContentType.VIDEO, "3", ContentUrl.MOVE3, null, null));
                vodContents1.add(new Content("4", "海贼王第710话", ContentUrl.Pic.PIC_BIG_4, ContentType.VIDEO, "4", ContentUrl.MOVE4, null, null));
                ...
                vodContents2.add(new Content("21", "霍比特人意外之旅", ContentUrl.Pic.PIC_SMALL_6, ContentType.VIDEO, "5", ContentUrl.MOVE5, "9.6", "10000次"));
                vodContents2.add(new Content("22", "指环王", ContentUrl.Pic.PIC_SMALL_7, ContentType.VIDEO, "6", ContentUrl.MOVE6, "9.6", "2000次"));
                ...
                vodContents3.add(new Content("31", "名侦探柯南", ContentUrl.Pic.PIC_SMALL_1, ContentType.TELEPLAY, "1", null, null, null));
                vodContents3.add(new Content("32", "全职猎人", ContentUrl.Pic.PIC_SMALL_2, ContentType.TELEPLAY, "2", null, null, null));
                vodContents3.add(new Content("33", "乌龙派出所", ContentUrl.Pic.PIC_SMALL_3, ContentType.TELEPLAY, "3", null, null, null));
                ...
                vodContents4.add(new Content("23", "幽游白书", ContentUrl.Pic.PIC_SMALL_4, ContentType.VIDEO, "8", ContentUrl.MOVE7, "9.6", null));
                vodContents4.add(new Content("24", "神奇宝贝", ContentUrl.Pic.PIC_SMALL_5, ContentType.VIDEO, "9", ContentUrl.MOVE8, "9.6", null));
    ...
    public GetContentsResp getContents(@RequestParam String userToken,
        ...
        contents.add(new Content("23", "幽游白书", ContentUrl.Pic.PIC_SMALL_4, ContentType.VIDEO, "8", ContentUrl.MOVE1, "9.6", null));
        contents.add(new Content("24", "神奇宝贝", ContentUrl.Pic.PIC_SMALL_5, ContentType.VIDEO, "9", ContentUrl.MOVE2, "9.6", null));
    ...
    public GetTeleplayDetailResp getTeleplayDetail(@RequestParam String userToken,
        ...
        switch (teleplayId) {
            case "1":
                teleplay = new Teleplay("1", "名侦探柯南", null, "导演", "柯南/新一/小兰", "真相只有一个", "9.1", "2001", "21亿", "40集", "25集", makeTeleplayVideos(25));
                break;
            case "2":
                teleplay = new Teleplay("2", "全职猎人", null, "导演", "小杰/西索", "惊险刺激的游戏世界,小杰与西索幻影旅团的精彩对决", "9.3", "2001", "500万", "8集", "8集", makeTeleplayVideos(8));
                break;
            case "3":
                teleplay = new Teleplay("3", "乌龙派出所", null, "导演", "两津勘吉/中山/本田", "龟有公园前派出所,爆笑登场", "9.9", "2001", "2000万", "32集", "32集", makeTeleplayVideos(32));
                break;
            default:
                teleplay = new Teleplay("1", "名侦探柯南", null, "导演", "柯南/新一/小兰", "真相只有一个", "9.1", "2001", "21亿", "40集", "25集", makeTeleplayVideos(25));
                break;
    ...
    private List<Video> makeTeleplayVideos(int updateCount) {
        ...
        videos.add(new Video("1", ContentUrl.MOVE1, "生化危机", null, "directors", "actors", "description", "8.9", null, "12345次", "95分钟", false));
        videos.add(new Video("2", ContentUrl.MOVE2, "古墓丽影", null, "directors", "actors", "description", "8.0", null, "31345次", "105分钟", false));
        videos.add(new Video("3", ContentUrl.MOVE3, "像素大战", null, "directors", "actors", "description", "9.0", null, "33345次", "112分钟", false));
        videos.add(new Video("4", ContentUrl.MOVE4, "地牢围攻", null, "directors", "actors", "description", "8.8", null, "12331次", "95分钟", false));
        videos.add(new Video("5", ContentUrl.MOVE5, "超能特工队", null, "directors", "actors", "description", "8.7", null, "55335次", "90分钟", false));
        videos.add(new Video("6", ContentUrl.MOVE6, "头脑特工队", null, "directors", "actors", "description", "9.9", null, "14242次", "93分钟", false));
        videos.add(new Video("7", ContentUrl.MOVE7, "熊出没之雪岭熊风", null, "directors", "actors", "description", "7.0", null, "12245次", "98分钟", false));
        videos.add(new Video("8", ContentUrl.MOVE8, "63_芈月传", null, "directors", "actors", "description", "7.7", null, "42545次", "97分钟", false));
        videos.add(new Video("9", ContentUrl.MOVE9, "十七岁", null, "directors", "actors", "description", "8.9", null, "1345次", "125分钟", false));
        videos.add(new Video("10", ContentUrl.MOVE10, "解救吾先生", null, "directors", "actors", "description", "9.1", null, "26445次", "153分钟", false));
    ...
    public GetVideoDetailResp getVideoDetail(@RequestParam String userToken,
        ...
        switch (videoId) {
            case "1":
                video = new Video("1", ContentUrl.MOVE1, "生化危机", null, "directors", "actors", "description", "8.9", null, "12345次", "95分钟", false);
                break;
            case "2":
                video = new Video("2", ContentUrl.MOVE2, "古墓丽影", null, "directors", "actors", "description", "8.0", null, "31345次", "105分钟", false);
                break;
            case "3":
                video = new Video("3", ContentUrl.MOVE3, "像素大战", null, "directors", "actors", "description", "9.0", null, "33345次", "112分钟", false);
                break;
            case "4":
                video = new Video("4", ContentUrl.MOVE4, "地牢围攻", null, "directors", "actors", "description", "8.8", null, "12331次", "95分钟", false);
                break;
            case "5":
                video = new Video("5", ContentUrl.MOVE5, "超能特工队", null, "directors", "actors", "description", "8.7", null, "55335次", "90分钟", false);
                break;
            case "6":
                video = new Video("6", ContentUrl.MOVE6, "头脑特工队", null, "directors", "actors", "description", "9.9", null, "14242次", "93分钟", false);
                break;
            case "7":
                video = new Video("7", ContentUrl.MOVE7, "熊出没之雪岭熊风", null, "directors", "actors", "description", "7.0", null, "12245次", "98分钟", false);
                break;
            case "8":
                video = new Video("8", ContentUrl.MOVE8, "63_芈月传", null, "directors", "actors", "description", "7.7", null, "42545次", "97分钟", false);
                break;
            case "9":
                video = new Video("9", ContentUrl.MOVE9, "十七岁", null, "directors", "actors", "description", "8.9", null, "1345次", "125分钟", false);
                break;
            case "10":
                video = new Video("10", ContentUrl.MOVE10, "解救吾先生", null, "directors", "actors", "description", "9.1", null, "26445次", "153分钟", false);
                break;
            default:
                video = new Video("10", ContentUrl.MOVE10, "解救吾先生", null, "directors", "actors", "description", "8.9", null, "12345次", "95分钟", false);
                break;
        }
        resp.video = video;
        resp.result = 0;
    ...
    public SearchResp search(@RequestParam String userToken,
                             ...
                             @RequestParam(required = false, defaultValue = "20") int limit) {
        List<Content> contents = new ArrayList<>();
        contents.add(new Content("23", "幽游白书", ContentUrl.Pic.PIC_SMALL_4, ContentType.VIDEO, "8", ContentUrl.MOVE3, "9.6", null));
        contents.add(new Content("24", "神奇宝贝", ContentUrl.Pic.PIC_SMALL_5, ContentType.VIDEO, "9", ContentUrl.MOVE4, "9.6", null));
